...
public class BasicSniperTeam extends BasicTeam
{
	public BasicSniperTeam(int id) {
		super(id);
		setName("Basic - Snipers");

	}
	
	public Robot createRobotOne(int x, int y) throws SlickException
	{
		return new BasicSniper(x, y, getID(), 1);
	}
	...
	protected Robot createRobotFour(int x, int y) throws SlickException {
		return new BasicSniper(x, y, getID(), 4);
	}
